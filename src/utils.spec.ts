...
describe('Utils', () => {
  describe('isEqual', () => {
    const expectEqual = (
      state1: null | number | object | string | undefined,
      state2: null | number | object | string | undefined,
      toBe: boolean
    ): void => expect(isEqual(state1, state2)).toBe(toBe);
